...
class TestGetTransactionByIndex(unittest.TestCase):
    ...
    def test_get_transaction_by_index_raises_exception(self):
        transaction = TransactionController.get_transaction_by_hash_value(self.block, "0x228e82c24b4bf71ace0e56ddb4f7aa045b04b840bf4c179673d5508f0c872e8d")
        self.assertEqual(transaction, self.block["transactions"][2])

    def test_get_transaction_by_index_returns_valid_transaction(self):
        with self.assertRaises(ErrorHandler) as ContextManager:
            TransactionController.get_transaction_by_hash_value(self.block, "0x128e82c24b4bf71ace0e56ddb3e7aa045b04b840bf4c179673d5508f0c872e83")
